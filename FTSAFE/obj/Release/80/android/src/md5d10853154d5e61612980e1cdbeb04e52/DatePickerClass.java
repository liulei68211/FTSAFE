...
/** @hide */
	...
	static {
		__md_methods = 
			...
			"";
		mono.android.Runtime.register ("FTSAFE.DatePickerClass, FTSAFE", DatePickerClass.class, __md_methods);
	}
	...
	{
		super ();
		if (getClass () == DatePickerClass.class)
			mono.android.TypeManager.Activate ("FTSAFE.DatePickerClass, FTSAFE", "", this, new java.lang.Object[] {  });
	}
