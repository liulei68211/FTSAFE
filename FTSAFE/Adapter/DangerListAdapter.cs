...
namespace FTSAFE.Adapter
{
    ...
    public class DangerListItem
    {
        ...
        public DangerListItem(int itemorder, string dangerobj, string dangerinfo, string dangerstand, string dangercontrol, string dangerlevel)
        {
    ...
    class DangerListAdapter : BaseAdapter<DangerListItem>
    {
        List<DangerListItem> items;
        Activity context;

        public DangerListAdapter(Activity context, List<DangerListItem> items) : base()
        {
            this.items = items;
        ...
        public override DangerListItem this[int position]
        {
        ...
        {
            ViewHolder holder;
            convertView = context.LayoutInflater.Inflate(Resource.Layout.danger_list_listview, null);
            DangerListItem item = items[position];
            if (convertView != null)
            {
